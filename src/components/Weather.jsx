...
const allIcons = {
  ...
  '09n': <LuCloudMoonRain title='Light Rain' aria-label='Light Rain' className="text-white w-24 h-24 mx-auto my-4" />,
  '10d': <LuCloudSunRain className="text-white w-24 h-24 mx-auto my-4" />,
  '10n': <LuCloudMoonRain title='Light Rain' aria-label='Light Rain' className="text-white w-24 h-24 mx-auto my-4" />,
